export const historySummaries = JSON.stringify([
  {
    id: 0,
    summaryDate: "December 10, 2024 • 3:20 PM",
    wordsCount: 77,
    charactersCount: 538,
    summaryText: `Naruto Uzumaki became the greatest shinobi of his time through
  ...
  {
    id: 1,
    summaryDate: "October 7, 2026 • 8:37 PM",
    wordsCount: 67,
    charactersCount: 345,
    summaryText: `Lorem ipsum dolor, sit amet consectetur adipisicing elit. Earum quis nam dicta nisi et adipisci aliquam deserunt, quibusdam nostrum quasi tempore enim. Vitae, odit deserunt voluptate quibusdam qui est necessitatibus ea rerum exercitationem laborum expedita deleniti itaque minus possimus dolorem, quidem ex reprehenderit. Accusamus beatae suscipit ipsum culpa, excepturi nisi inventore doloremque expedita nam perferendis, delectus illum consectetur! Laborum ex unde quibusdam! Quos similique perferendis temporibus, dolorum mollitia sapiente illum sed consectetur magni, tempora incidunt at debitis?`,
  },
  {
    id: 2,
