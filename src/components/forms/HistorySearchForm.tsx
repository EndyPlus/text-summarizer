  ...
  return (
    ...
    >
      ...
      <div className="xs:w-3/7 relative w-2/3">
        ...
        <input
          className="border-border hover:border-black-base base-transition leading-base tracking-base placeholder:text-placeholder shadow-input text-black-base rounded-large w-full border py-1.5 pr-2 pl-8.5 text-sm"
          type="text"
          placeholder="Search"
